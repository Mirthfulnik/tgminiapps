...
const defaultApps = [
    {
        name: "TON Wallet",
        url: "https://t.me/wallet_bot/start",
        icon: "💰",
        category: "Finance",
        description: "Official TON Wallet for transactions",
        id: "ton-wallet",
        addedDate: Date.now()
    },
    {
        name: "CryptoBot",
        url: "https://t.me/CryptoBot/app",
        icon: "₿",
        category: "Finance", 
        description: "Cryptocurrency exchange bot",
        id: "cryptobot",
        addedDate: Date.now()
    },
    {
        ...
        icon: "🐹",
        category: "Games",
        description: "Popular clicker game",
        id: "hamster-kombat",
        addedDate: Date.now()
    },
    {
        name: "Notcoin",
        url: "https://t.me/notcoin_bot/start", 
        icon: "🪙",
        category: "Games",
    ...
    {
        name: "Blum",
        url: "https://t.me/blum/app",
        icon: "🌸",
        category: "Games", 
        description: "Crypto farming game",
        id: "blum",
        addedDate: Date.now()
    },
    {
    ...
    },
    {
        ...
        description: "NFT and username marketplace",
        id: "fragment",
        addedDate: Date.now()
    },
    {
        ...
        icon: "🛒",
        category: "Shopping",
        description: "Official Telegram shop",
        id: "telegram-shop",
        addedDate: Date.now()
    }
];
